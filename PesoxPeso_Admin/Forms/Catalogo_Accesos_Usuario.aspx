...
<asp:Content ID="Content1" ContentPlaceHolderID="FeaturedContent" runat="server">
    <link href="<%= ResolveUrl("~/content/css/plugins/chosen/chosen.css") %>" rel="stylesheet" />
</asp:Content>
    ...
    <asp:UpdatePanel runat="server" ID="UP_Pagina" UpdateMode="Always">
        <ContentTemplate>
            ...
            <div class="row" style="margin-top: 20px">
                ...
                <div class="col-lg-7">
                    <asp:DropDownList ID="Usuarios_DropDownList" runat="server" CssClass="chosen-select" DataSourceID="Usuarios_SqlDataSource"
                        DataTextField="nombre" DataValueField="id_General_Usuario" Width="50%" AutoPostBack="True"
                        OnSelectedIndexChanged="Usuarios_DropDownList_SelectedIndexChanged">
                    </asp:DropDownList>

                    <asp:SqlDataSource ID="Usuarios_SqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:db_Peso_x_Peso_ConnectionString %>"
                        SelectCommand="spr_Generales_lee_usuarios_por_estatus" SelectCommandType="StoredProcedure">
                        <SelectParameters>
                ...
                <div class="col-lg-12" style="margin-top: 20px">
                    ...
                    <asp:SqlDataSource ID="Accesos_por_Usuario_SqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:db_Peso_x_Peso_ConnectionString %>" SelectCommand="spr_Generales_lee_accesos_por_usuario_catalogo" SelectCommandType="StoredProcedure">
                        <SelectParameters>
                    ...
                    <asp:SqlDataSource ID="Accesos_SqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:db_Peso_x_Peso_ConnectionString %>"
                        SelectCommand="spr_Generales_lee_accesos" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
                </div>
            </div>
