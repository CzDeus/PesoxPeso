<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Catalogo_Municipios.aspx.cs" Inherits="Forms_Catalogo_Municipios" %>
        ...
        <ContentTemplate>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="ibox">
                            <h3 class="ibox-title">Listado de municipios</h3>
                            <div class="ibox-content">
                                ...
                                <div class="form-group">
                                    <asp:Button ID="btnNuevoMunicipio" runat="server" Text="Nuevo Municipio" CssClass="btn btn-w-m btn-info" OnClick="btnNuevoMunicipio_Click" />
                                </div>
                                <div class="form-group">
                                    <asp:GridView ID="Municipios_GridView" runat="server" AutoGenerateColumns="False"
                                        DataSourceID="Municipios_EntityDataSource" DataKeyNames="id_municipio" CssClass="table table-hover table-bordered"
                                        EmptyDataText="No han registrado Municipios..." AllowPaging="True" BorderStyle="None" Width="90%" PageSize="5" OnRowCommand="Municipios_GridView_RowCommand">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="nombre_municipio" HeaderText="Nombre Municipios" />
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Catálogo Municipios</h4>
                        </div>
                        <div class="modal-body">
                            <asp:DetailsView ID="Municipios_DetailsView" runat="server" CssClass="table table-bordered table-hover"
                                AutoGenerateRows="False" DataSourceID="Registro_Municipios_EntityDataSource"
                                DataKeyNames="id_municipio" EmptyDataText="No ha seleccionado municipio..."
                                OnDataBound="Municipios_DetailsView_DataBound" OnItemInserting="Municipios_DetailsView_ItemInserting"
                                OnItemUpdating="Municipios_DetailsView_ItemUpdating" OnItemCommand="Municipios_DetailsView_ItemCommand">
                                    ...
                                    <asp:TemplateField HeaderText="Nombre">
                                        <ItemTemplate>
                                            <asp:TextBox ID="Nombre_TextBox" runat="server" class="form-control" ReadOnly="true"
                                                Text='<%# Bind("nombre_municipio")%>' MaxLength="30" Width="200px"></asp:TextBox>
                                        </ItemTemplate>
                                        <EditItemTemplate>
            ...
            <asp:EntityDataSource ID="Registro_Municipios_EntityDataSource" runat="server" Where="it.id_municipio = @id_registro" ConnectionString="name=PesoxPeso_modelContainer" DefaultContainerName="PesoxPeso_modelContainer"
                EnableDelete="True" EnableFlattening="False" EnableInsert="True" EnableUpdate="True" EntitySetName="Catalogo_Municipios">
                <WhereParameters>
                    <asp:ControlParameter ControlID="Municipios_GridView" Name="id_registro" PropertyName="SelectedValue" Type="Int32" ConvertEmptyStringToNull="False" DefaultValue="0" />
                </WhereParameters>
            </asp:EntityDataSource>

            <asp:EntityDataSource ID="Municipios_EntityDataSource" runat="server" OrderBy="it.nombre_municipio" Where="it.nombre_municipio Like '%' + @nombre_buscar + '%'" ConnectionString="name=PesoxPeso_modelContainer" DefaultContainerName="PesoxPeso_modelContainer" EnableFlattening="False" EntitySetName="Catalogo_Municipios" EntityTypeFilter="Catalogo_Municipios">
                <WhereParameters>
