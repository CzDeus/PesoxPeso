            ...
            else
            {
                ...
                try
                {
                    ...
                    if (id_registro != 0)
                    {
                        ...
                        Email.mensaje = "Dar click <a href='http://localhost:60980/ResetPassword.aspx?request=" + id_encrypt_usuario + "&guid=" + encrypt_guid + "'>Aquí</a> para especificar su nueva Contraseña.";
