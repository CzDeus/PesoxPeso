...
public partial class Forms_Catalogo_Usuarios_2 : System.Web.UI.Page
{
    ...
    protected void Delete_Button_Click(object sender, EventArgs e)
    {
        ...
        {
            SqlCommand sql_command = new SqlCommand("spr_Valida_eliminar_usuario", connection);
            sql_command.CommandType = CommandType.StoredProcedure;

            sql_command.Parameters.Add("@id_General_Usuario", SqlDbType.Int);
            sql_command.Parameters["@id_General_Usuario"].Value = Usuarios_DetailsView.SelectedValue;
    ...
    protected void Usuarios_DetailsView_ItemInserting(object sender, DetailsViewInsertEventArgs e)
    {
        ...
        wcancelar = valida_captura(e.Values["estatus"], wcancelar);
    ...
    protected void Usuarios_DetailsView_ItemUpdating(object sender, DetailsViewUpdateEventArgs e)
    {
        ...
        wcancelar = valida_captura(e.NewValues["estatus"], wcancelar);
    ...
    protected void Usuarios_GridView_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        boolBuscar = false;
