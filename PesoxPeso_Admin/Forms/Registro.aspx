...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="Server">
    <asp:UpdatePanel runat="server" ID="UP_Pagina" UpdateMode="Always">
        <ContentTemplate>
            <div class="row">
                <div class="col-lg-offset-4 col-lg-4" style="text-align: center; background: #CCCCCC">
                    <h1><b>
            ...
            <div class="row">
                ...
                <div class="col-lg-12" style="text-align: center">
                    ...
                    <h5>(De acuerdo al acta constitucional)</h5>
                </div>
                <div class="col-lg-offset-4 col-lg-4">
                    <asp:TextBox ID="Nombre_InstitucionTextBox" runat="server" class="form-control"></asp:TextBox>
                </div>
                <div class="col-lg-offset-4 col-lg-4" style="text-align:center">
                    ...
                    <asp:TextBox ID="RFC_institucion_TextBox" runat="server" class="form-control"></asp:TextBox>
                </div>
                ...
                <div class="col-lg-offset-4 col-lg-4" style="text-align: center">
                    ...
                    <asp:TextBox ID="Nombre_Persona_TextBox" runat="server" class="form-control"></asp:TextBox>
                ...
                <div class="col-lg-offset-4 col-lg-4" style="text-align: center">
                    ...
                    <asp:TextBox ID="Correo_TextBox" runat="server" class="form-control"></asp:TextBox>
                </div>
                ...
                <div class="col-lg-offset-4 col-lg-4" style="text-align: center">
                    ...
                    <asp:TextBox ID="Confirmar_Correo_TextBox" runat="server" class="form-control"></asp:TextBox>
                </div>
