<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Catalogo_Usuarios.aspx.cs" Inherits="Forms_Catalogo_Usuarios_2" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="Server">
    <asp:UpdatePanel runat="server" ID="UpdatePanel1" UpdateMode="Always">
        <ContentTemplate>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox">
                            ...
                            <div class="ibox-content">
                                ...
                                <div class="form-group">
                                    <asp:GridView ID="Usuarios_GridView" runat="server" AutoGenerateColumns="False"
                                        DataSourceID="Usuarios_EntityDataSource" DataKeyNames="id_General_Usuario" CssClass="table table-hover table-bordered"
                                        EmptyDataText="No han registrado Usuarios..." AllowPaging="True" BorderStyle="None" Width="90%" PageSize="5" OnRowCommand="Usuarios_GridView_RowCommand">
                                        <Columns>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <asp:DetailsView ID="Usuarios_DetailsView" runat="server" CssClass="table table-bordered table-hover"
                                ...
                                DataKeyNames="id_General_Usuario" EmptyDataText="No ha seleccionado municipio..."
                                    ...
                                    <asp:TemplateField HeaderText="Correo">
                                        <ItemTemplate>
                                            <asp:TextBox ID="Correo_TextBox" runat="server" class="form-control" ReadOnly="true"
                                                Text='<%# Bind("correo")%>' MaxLength="30" Width="200px"></asp:TextBox>
                                        </ItemTemplate>
                                        <EditItemTemplate>
            ...
            <div class="modal fade" tabindex="-1" role="dialog" id="div_alertas">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <asp:Label ID="Label3" Text="" runat="server" class="mensaje" Font-Bold="True" Font-Size="X-Large" />
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal" onclick="hideModal()">Cerrar</button>
                        </div>
            ...
            <asp:EntityDataSource ID="Registro_Usuarios_EntityDataSource" runat="server" Where="it.id_General_Usuario = @id_registro" ConnectionString="name=PesoxPeso_modelContainer" DefaultContainerName="PesoxPeso_modelContainer"
                EnableDelete="True" EnableFlattening="False" EnableInsert="True" EnableUpdate="True" EntitySetName="tb_Generales_Usuarios">
                <WhereParameters>
            ...
            <asp:EntityDataSource ID="Usuarios_EntityDataSource" runat="server" OrderBy="it.nombre" Where="it.nombre Like '%' + @nombre_buscar + '%'" ConnectionString="name=PesoxPeso_modelContainer" DefaultContainerName="PesoxPeso_modelContainer" EnableFlattening="False" EntitySetName="tb_Generales_Usuarios" EntityTypeFilter="tb_Generales_Usuarios">
                <WhereParameters>
