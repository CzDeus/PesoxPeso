...
public class csNodo
{
    ...
    public List<int> RecorrerNodos(List<int> listNodo, TreeNodeCollection treeNodeCollection, out bool boolHijo)
    {
        boolHijo = false;
        ...
        for (int x = 0; x < treeNodeCollection.Count; x++)
        {
            ...
            {
                RecorrerNodos(listNodo, treeNodeCollection[x].ChildNodes, out boolHijo);
